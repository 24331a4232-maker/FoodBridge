...
const sections = [
  ...
  { icon: Scale, title: 'Intellectual Property', content: 'All content, logos, and branding on FoodBridge are owned by FoodBridge. User-generated content remains the property of the user, with a license granted to FoodBridge for platform operations.' },
